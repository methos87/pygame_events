...
def create_scale(height):
    red_scale_surfate = pygame.surface.Surface((640, height))
    ...
    for x in range(640):
        ...
        pygame.draw.rect(red_scale_surfate, red, line_rect)
        pygame.draw.rect(green_scale_surface, green, line_rect)
        pygame.draw.rect(blue_scale_surface, blue, line_rect)
    return red_scale_surfate, green_scale_surface, blue_scale_surface
...
while True:
    ...
    # drawing the scales to the screen
